# FirstNews Lua SDK Reference

Complete API reference for the FirstNews Lua SDK.
...
| --- | --- | --- | --- |
| `channels` | `table` | No | List of news channels this item is published on |
...
```lua
local result, err = client:New():load({ id = 1 })
```
