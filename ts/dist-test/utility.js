...
function envOverride(m) {
    if ('TRUE' === process.env.FIRST_NEWS_TEST_LIVE ||
        'TRUE' === process.env.FIRST_NEWS_TEST_OVERRIDE) {
    ...
    m.FIRST_NEWS_TEST_EXPLAIN = process.env.FIRST_NEWS_TEST_EXPLAIN || m.FIRST_NEWS_TEST_EXPLAIN;
    return m;
}
