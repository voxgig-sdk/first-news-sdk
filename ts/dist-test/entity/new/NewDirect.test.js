...
(0, node_test_1.describe)('NewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FirstNewsSDK({
...
function liveScenariosActive() { return false && process.env.FIRST_NEWS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FirstNewsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FIRST_NEWS_TEST_NEW_ENTID'];
    ...
    const client = new __1.FirstNewsSDK({
        base: 'http://localhost:8080',
