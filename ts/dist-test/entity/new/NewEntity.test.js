...
(0, node_test_1.describe)('NewEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('FIRST_NEWS_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.FirstNewsSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(new_ref01_data_dt0.id === new_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let client = __1.FirstNewsSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.FirstNewsSDK(merge([
