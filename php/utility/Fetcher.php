...
class FirstNewsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FirstNewsSDK/1.0)';
    ...
    public static function call(FirstNewsContext $ctx, string $fullurl, array $fetchdef): array
    {
