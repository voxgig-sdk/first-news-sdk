...
// FirstNews SDK clienttrack feature
...
class FirstNewsClienttrackFeature extends FirstNewsBaseFeature
{
    ...
    public function PostConstruct(FirstNewsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FirstNews-SDK';
