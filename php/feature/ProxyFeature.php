...
class FirstNewsProxyFeature extends FirstNewsBaseFeature
{
    ...
    public function init(FirstNewsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FirstNewsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
