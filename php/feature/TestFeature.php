...
// FirstNews SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FirstNewsTestFeature extends FirstNewsBaseFeature
{
    ...
    public function init(FirstNewsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FirstNewsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FirstNewsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FirstNewsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FirstNewsContext $ctx, $op, $args): array
    {
