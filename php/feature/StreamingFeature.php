...
// FirstNews SDK streaming feature
...
class FirstNewsStreamingFeature extends FirstNewsBaseFeature
{
    ...
    private function _iterate(FirstNewsResult $result): \Generator
    {
    ...
    private function _streamable(FirstNewsContext $ctx): bool
    {
