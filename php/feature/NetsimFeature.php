...
class FirstNewsNetsimFeature extends FirstNewsBaseFeature
{
    ...
    private function _simulate(FirstNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FirstNewsContext $ctx, array $applied): void
    {
        $client = $this->client;
