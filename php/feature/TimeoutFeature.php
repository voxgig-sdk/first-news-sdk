...
class FirstNewsTimeoutFeature extends FirstNewsBaseFeature
{
    ...
    private function _with_timeout(FirstNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FirstNewsContext $_ctx, float $ms): void
    {
        $client = $this->client;
