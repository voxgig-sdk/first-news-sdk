...
// FirstNews SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FirstNewsSDK::test)
...
{
    private const SDK_CLASS = 'FirstNewsSDK';
    ...
    private const SDK_BASE = 'firstnews_sdk';
