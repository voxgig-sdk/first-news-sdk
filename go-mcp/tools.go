...
func registerTools(server *mcp.Server, client *sdk.FirstNewsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "first-news_list",
		Description: "List records from FirstNews. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "first-news_load",
		Description: "Load a single record from FirstNews. " +
...
func runOp(client *sdk.FirstNewsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FirstNewsSDK, name string) (sdk.FirstNewsEntity, error) {
