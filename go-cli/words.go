...
func registerSDKWords(r *eng.Registry, client *sdk.FirstNewsSDK) {
...
func runOp(client *sdk.FirstNewsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
