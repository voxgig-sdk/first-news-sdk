// Command FirstNews-cli is a CLI + REPL for the FirstNews SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FIRST_NEWS_APIKEY (api key), FIRST_NEWS_BASE (base url override)")
