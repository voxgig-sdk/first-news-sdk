...
class FirstNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FirstNewsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FirstNewsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FirstNewsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
