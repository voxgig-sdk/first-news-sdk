...
from projectname_sdk import FirstNewsSDK
from projectname_sdk.core.spec import FirstNewsSpec
from projectname_sdk.core.result import FirstNewsResult
from projectname_sdk.core.response import FirstNewsResponse
from projectname_sdk.core.operation import FirstNewsOperation
from projectname_sdk.core.error import FirstNewsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FirstNewsBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FirstNewsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FirstNewsSDK.test(None, None)
        ...
        class TestInitFeature(FirstNewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FirstNewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FirstNewsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FirstNewsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FirstNewsSDK.test(None, setup_opts)
