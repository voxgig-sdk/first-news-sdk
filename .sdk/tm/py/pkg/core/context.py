...
from projectname_sdk.core.control import FirstNewsControl
...
class FirstNewsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FirstNewsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FirstNewsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FirstNewsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FirstNewsError(code, msg, self)
