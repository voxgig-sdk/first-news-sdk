# FirstNews SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, FirstNewsError):
        errmsg = err.msg
    ...
    msg = "FirstNewsSDK: " + opname + ": " + errmsg
    ...
    sdk_err = FirstNewsError("", msg, ctx)
