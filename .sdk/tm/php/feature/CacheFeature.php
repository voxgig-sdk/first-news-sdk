...
class FirstNewsCacheFeature extends FirstNewsBaseFeature
{
    ...
    private function _through(FirstNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
