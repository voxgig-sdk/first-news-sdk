...
// FirstNews SDK ratelimit feature
...
class FirstNewsRatelimitFeature extends FirstNewsBaseFeature
{
    ...
    private function _acquire(FirstNewsContext $ctx): void
    {
    ...
    private function _track(FirstNewsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
