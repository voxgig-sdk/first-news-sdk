...
class FirstNewsRbacFeature extends FirstNewsBaseFeature
{
    ...
    private function _required(FirstNewsContext $ctx): ?string
    {
    ...
    private function _reject(FirstNewsContext $ctx, string $required): void
    {
    ...
    private function _track(FirstNewsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
