...
class FirstNewsGraphql
{
    ...
    // equivalent.
    public static function body(FirstNewsContext $ctx): mixed
    {
    ...
    public static function errors(FirstNewsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
