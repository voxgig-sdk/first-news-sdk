...
// FirstNews SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FirstNewsTransformResponse
{
    public static function call(FirstNewsContext $ctx): mixed
    {
        ...
        $transform = FirstNewsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
