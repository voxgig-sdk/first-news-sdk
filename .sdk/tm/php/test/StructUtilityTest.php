...
// FirstNews SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FirstNewsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FirstNewsOmni::structfix($now, Struct::undef()))
                        !== json_encode(FirstNewsOmni::structfix($val, Struct::undef()))) {
