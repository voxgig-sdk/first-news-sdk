...
|---|---|---|
| `ts/` | @voxgig-sdk/first-news-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/first-news-sdk \
      --repository voxgig-sdk/first-news-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/first-news-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/first-news-sdk --id=<id>` removes one.
