...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/first-news` | `npm install @voxgig-sdk/first-news` |
| Python | `voxgig-sdk-first-news` | `pip install voxgig-sdk-first-news` |
| PHP | `voxgig-sdk/first-news` | `composer require voxgig-sdk/first-news` |
| Golang | `github.com/voxgig-sdk/first-news-sdk/go` | `go get github.com/voxgig-sdk/first-news-sdk/go` |
| Ruby | `voxgig-sdk-first-news` | `gem install voxgig-sdk-first-news` |
| Lua | `voxgig-sdk-first-news` | `luarocks install voxgig-sdk-first-news` |
