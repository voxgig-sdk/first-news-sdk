...
from firstnews_sdk.utility import register

# Load features
from firstnews_sdk.feature.base_feature import FirstNewsBaseFeature
from firstnews_sdk.features import _has_feature, _make_feature
...
class FirstNewsSDK:
    ...
    def get_utility(self):
        return FirstNewsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FirstNewsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def New(self, data=None) -> "NewEntity":
        ...
        from firstnews_sdk.entity.new_entity import NewEntity
