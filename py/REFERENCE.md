# FirstNews Python SDK Reference

Complete API reference for the FirstNews Python SDK.
...
#### `FirstNewsSDK.test(testopts=None, sdkopts=None)`
...
```python
result, err = client.New().load({"id": "new_id"})
```
