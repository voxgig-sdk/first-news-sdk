# FirstNews SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FirstNewsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FirstNewsSDK(...) and FirstNewsSDK.test(...) become
#      FirstNewsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "firstnews_sdk"
_SDK_CLASS = "FirstNewsSDK"
