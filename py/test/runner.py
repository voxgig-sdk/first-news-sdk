...
class FirstNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FirstNewsTestRunner.getenv("FIRST_NEWS_TEST_LIVE")
        override = FirstNewsTestRunner.getenv("FIRST_NEWS_TEST_OVERRIDE")
        ...
        explain = FirstNewsTestRunner.getenv("FIRST_NEWS_TEST_EXPLAIN")
