...
class FirstNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FirstNewsTestRunner.getenv("FIRSTNEWS_TEST_LIVE")
        override = FirstNewsTestRunner.getenv("FIRSTNEWS_TEST_OVERRIDE")
        ...
        explain = FirstNewsTestRunner.getenv("FIRSTNEWS_TEST_EXPLAIN")
